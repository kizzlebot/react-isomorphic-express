...
/******/ 	var hotCurrentHash = "b3fa12ff6f8a345bd9b6"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Transmit = __webpack_require__(12);
	...
	var createRoutes = __webpack_require__(16);
	var pkg = __webpack_require__(43);
	var passportConfig = __webpack_require__(44);
	var githubApi = __webpack_require__(29);
	var middlewareConfig = __webpack_require__(54);
	...
	app.set('env',  false ? 'production' : 'development');
	...
	middlewareConfig(app, __dirname, function () {
		...
		app.use('/api/github', proxy(githubApi.url, {
			forwardPath: function forwardPath(req, res) {
				return __webpack_require__(69).parse(req.url).path;
			}
		}));
	  ...
	  */
		app.use(function (req, res, next) {
			...
			var history = (0, _history.useQueries)(_history.createMemoryHistory)();
			...
			ReactRouter.match({ routes: routes, location: location }, function (error, redirectLocation, renderProps) {
				...
				Transmit.renderToString(ReactRouter.RouterContext, _extends({}, renderProps, { csrf: res.locals._csrf })).then(function (_ref) {
					...
					var body = Transmit.injectIntoMarkup(template, _extends({}, reactData, { csrf: res.locals._csrf }), [webserver + "/dist/client.js"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stargazers = __webpack_require__(28);
	
	var _stargazers2 = _interopRequireDefault(_stargazers);
	
	var _linkedin = __webpack_require__(34);
	...
	var _apis = __webpack_require__(36);
		...
		if (history) {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					_reactRouter.Route,
					{ path: '/', component: _app2.default, store: _userStore.userStore },
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_reactRouter.Route, { path: 'stargazers', component: _stargazers2.default })
					),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = _react2.default.createClass({
			...
			getInitialState: function getInitialState() {
					return _userStore2.default.getState();
			},
			componentDidMount: function componentDidMount() {
					var _this = this;
	
					_userStore2.default.subscribe(function (data) {
							_this.setState(_extends({}, _userStore2.default.getState()));
					});
			},
							...
							_react2.default.createElement(
									...
									_react2.default.createElement(
											...
											_react2.default.createElement(
													...
													{ eventKey: 2, title: 'APIs', id: 'basic-nav-dropdown' },
													_react2.default.createElement(
															_reactRouterBootstrap.LinkContainer,
															{ to: { pathname: '/api/github' } },
															_react2.default.createElement(
																	_reactBootstrap.NavItem,
																	{ eventKey: 2.1, href: '#' },
																	'Github'
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.get_profile = exports.sign_up = exports.log_out = exports.log_in = undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function auth() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? { csrf: null } : arguments[0];
	...
	exports.default = (0, _redux.createStore)(auth);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactTransmit = __webpack_require__(12);
	
	var _reactTransmit2 = _interopRequireDefault(_reactTransmit);
	
	var _github = __webpack_require__(29);
	...
	var Stargazers = function (_React$Component) {
		...
		function Stargazers() {
			_classCallCheck(this, Stargazers);
	
			return _possibleConstructorReturn(this, Object.getPrototypeOf(Stargazers).apply(this, arguments));
		}
	
		_createClass(Stargazers, [{
	   ...
	   */
			value: function componentWillMount() {
				if (true) console.log("Hello server");
				if (false) console.log("Hello client");
			}
	...
	Stargazers.propTypes = {
		additionalStargazers: _react2.default.PropTypes.array,
	 ...
	 */
	exports.default = _reactTransmit2.default.createContainer(Stargazers, {
		initialVariables: {
			nextPage: 2,
			pagesToFetch: 15,
			additionalStargazers: []
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fetchPlus = __webpack_require__(31);
	
	var _fetchPlus2 = _interopRequireDefault(_fetchPlus);
	
	var _fetchPlusJson = __webpack_require__(32);
	
	var _fetchPlusJson2 = _interopRequireDefault(_fetchPlusJson);
	
	var _fetchPlusBearerauth = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _boundActions = __webpack_require__(38);
	
	var actions = _interopRequireWildcard(_boundActions);
	...
	var Login = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    _userStore2.default.subscribe(function (data) {
	      var state = _extends({}, _userStore2.default.getState());
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.submitLogin = exports.submitSignup = undefined;
	...
	var submitLogin = function submitLogin(form) {
		return $.ajax({
			url: '/login',
			data: {
			...
			_userStore.userStore.dispatch((0, _actionCreators.log_in)());
			return Promise.resolve(xData, status, xhr);
		});
	};
	
	var submitSignup = function submitSignup(form) {
		return $.ajax({
			url: '/signup',
			data: {
				email: form.email.value,
			...
			_userStore.userStore.dispatch((0, _actionCreators.sign_up)());
			return Promise.resolve(xData, status, xhr);
		});
	};
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { type: 'hidden', id: 'csrf', name: '_csrf' }),
	        _react2.default.createElement(
	          'div',
	          { className: 'form-group' },
	          _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _favicon = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GitHubStrategy = __webpack_require__(49).Strategy;
	var GoogleStrategy = __webpack_require__(50).OAuth2Strategy;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bcrypt = __webpack_require__(52);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var compress = __webpack_require__(56);
	var session = __webpack_require__(57);
	var bodyParser = __webpack_require__(58);
	var logger = __webpack_require__(59);
	var errorHandler = __webpack_require__(9);
	var lusca = __webpack_require__(60);
	var methodOverride = __webpack_require__(61);
	var dotenv = __webpack_require__(6);
	var MongoStore = __webpack_require__(62)(session);
	var flash = __webpack_require__(63);
	var path = __webpack_require__(64);
	var mongoose = __webpack_require__(8);
	var passport = __webpack_require__(14);
	var expressValidator = __webpack_require__(65);
	var sass = __webpack_require__(66);
	var multer = __webpack_require__(67);
	var express = __webpack_require__(7);
	var csrf = __webpack_require__(68);
