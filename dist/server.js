...
/******/ 	var hotCurrentHash = "04b1c6aeca9507ee91f9"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createRoutes = __webpack_require__(17);
	var pkg = __webpack_require__(44);
	var passportConfig = __webpack_require__(45);
	var githubApi = __webpack_require__(30);
	var middlewareConfig = __webpack_require__(55);
	...
	middlewareConfig(app, __dirname, function () {
		...
		app.use('/api/github', proxy(githubApi.url, {
			forwardPath: function forwardPath(req, res) {
				return __webpack_require__(70).parse(req.url).path;
			}
		}));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _github = __webpack_require__(28);
	
	var _github2 = _interopRequireDefault(_github);
	
	var _stargazers = __webpack_require__(29);
	
	var _stargazers2 = _interopRequireDefault(_stargazers);
	
	var _linkedin = __webpack_require__(35);
	...
	var _apis = __webpack_require__(37);
	...
	var _userStore = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fetchPlus = __webpack_require__(32);
	
	var _fetchPlus2 = _interopRequireDefault(_fetchPlus);
	
	var _fetchPlusJson = __webpack_require__(33);
	
	var _fetchPlusJson2 = _interopRequireDefault(_fetchPlusJson);
	
	var _fetchPlusBearerauth = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _boundActions = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var submitLogin = function submitLogin(form) {
		return $.ajax({
			...
			_userStore2.default.dispatch((0, _actionCreators.log_in)());
	...
	var submitSignup = function submitSignup(form) {
		return $.ajax({
			...
			_userStore2.default.dispatch((0, _actionCreators.sign_up)());
			return Promise.resolve(xData, status, xhr);
		});
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _favicon = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GitHubStrategy = __webpack_require__(50).Strategy;
	var GoogleStrategy = __webpack_require__(51).OAuth2Strategy;
	
	var User = __webpack_require__(52);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bcrypt = __webpack_require__(53);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var compress = __webpack_require__(57);
	var session = __webpack_require__(58);
	var bodyParser = __webpack_require__(59);
	var logger = __webpack_require__(60);
	var errorHandler = __webpack_require__(10);
	var lusca = __webpack_require__(61);
	var methodOverride = __webpack_require__(62);
	var dotenv = __webpack_require__(7);
	var MongoStore = __webpack_require__(63)(session);
	var flash = __webpack_require__(64);
	var path = __webpack_require__(65);
	var mongoose = __webpack_require__(9);
	var passport = __webpack_require__(15);
	var expressValidator = __webpack_require__(66);
	var sass = __webpack_require__(67);
	var multer = __webpack_require__(68);
	var express = __webpack_require__(8);
	var csrf = __webpack_require__(69);
